                ...
                <div class="container">
                    <div class="row">
									...
									<div class="search-header hidden-600">
                                        <a href="#">
                                            <svg x="0" y="0" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
												...
												<image src="{!! Theme::asset('img/search-icon.png') !!}" alt="" width="16" height="16" style="vertical-align: top;">
											</svg>
                                        </a>
                                    </div><!--search-header-->
									@endif
                        ...
                        <div class="search-active col-sm-9 col-md-9">
                            <a href="#" class="close"><i class="fa fa-close"></i>  </a>
                            <form name="search-form" method="GET" action="{!! url('search/') !!}" class="search-form">
                                <input class="search-string form-control" type="search" placeholder="{!! Lang::get('app.search here') !!}" name="q">
